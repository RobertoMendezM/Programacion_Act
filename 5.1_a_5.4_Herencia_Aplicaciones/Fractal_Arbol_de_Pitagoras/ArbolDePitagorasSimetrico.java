 ...
 *   Triángilo rectángulo a 45 grados)
 *
 * Objetivos: Tema 5. Herencia
 *            Recursividad
 *            Graficación
 *            Geometría Básica
 *
...
import javax.swing.*;
import java.awt.*;
// De apoyo para controlar la velocidad de graficación
import java.util.concurrent.*;

public class ArbolDePitagorasSimetrico extends JFrame {
    ...
    void paintTree(Graphics g, double x1, double y1,
        ...
        if (dx * dx + dy * dy > 2) {
            ...
            // Solo para realentizar y que se vea el proceso de
            // construcción del fractal (Meramente Educativo)
            try {
             ...
             * con la grafica y los nuevos puntos base de los cuadrados
             */
